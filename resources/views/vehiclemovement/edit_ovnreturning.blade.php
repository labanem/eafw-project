...
<section id="">
	...
	<h3 class="heading">Return OverNight Vehicles</h3>
		<form action="{{ route('update_ovnreturning', $travelplan->id) }}" method="post">
		<div class="display-forms">
			...
			<input placeholder="Time out" type="text" name="timeout" id="timeout" value="{{ $travelplan->timeout }}" disabled /><br>
			...
			<input placeholder="Mileage-Out" type="text" name="mileageout" id="mileageout" value="{{ $travelplan->mileageout }}" disabled /><br>
			...
			<input type="text" value="{{ $travelplan->destname }}" name="destname" id="destname" disabled /><br>
			<br>

			<label for="dateout">Date Out:</label><br>
			<input placeholder="Date out" type="text" name="dateout" class="datepicker" value="{{ $travelplan->dateout }}" disabled /><br>
